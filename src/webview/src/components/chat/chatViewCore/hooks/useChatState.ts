...
export function useChatState(messages: ClineMessage[]): ChatState {
	...
	const [primaryButtonText, setPrimaryButtonText] = useState<string | undefined>("승인")
	const [secondaryButtonText, setSecondaryButtonText] = useState<string | undefined>("거부")
