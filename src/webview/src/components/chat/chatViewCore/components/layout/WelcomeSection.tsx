...
import { AccountServiceClient, StateServiceClient, UiServiceClient, WorktreeServiceClient } from "@/services/grpcClient"
			...
			<div className="overflow-y-auto flex flex-col pb-2.5">
				...
				{!showWhatsNewModal && (
					<>
						...
						{!shouldShowQuickWins && <HistoryPreview showHistoryView={showHistoryView} />}
