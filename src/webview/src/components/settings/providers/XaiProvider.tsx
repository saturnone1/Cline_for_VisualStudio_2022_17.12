...
import { DROPDOWN_Z_INDEX, DropdownContainer, ModelSelector } from "../common/ModelSelector"
			...
			<div>
				...
				<p
					...
					<span style={{ color: "var(--vscode-errorForeground)" }}>
						(<span style={{ fontWeight: 500 }}>Note:</span> LIG VS uses complex prompts and works best with Claude
