...
- Checkpoint timeline rendering and local pending state live in `components/chat/checkpoints`; checkpoint creation and restore behavior remain sidecar-owned.
