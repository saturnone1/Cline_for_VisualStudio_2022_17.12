...
export type AgentEvent =
	...
	| { type: "AgentDone"; sessionId: string; reason: string; result: AgentEventPayload; completion: AgentEventPayload; raw: AgentEventPayload }
	| { type: "AgentError"; sessionId: string; error: unknown; recoverable: boolean; iteration?: number; raw: AgentEventPayload }
